...
{
 public: 
 static void processing(struct Button *button,int buttonLevel,CallbackFunction clickFunc,CallbackFunction doubleClickFunc,CallbackFunction longPressStartFunc,CallbackFunction longPressStopFunc,CallbackFunction duringLongPressFunc);
